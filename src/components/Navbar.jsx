...
const Navbar = ({ texto, ruta, id, perfil, verVenta, verCompras }) => {
  ...
  const mostrarAside = (n) =>
    asideVentas ? setAsideVentas(false) : setAsideVentas(true);
      ...
      <div className="max-md:hidden w-full flex justify-between px-5 items-center gap-2">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            <Link
              to={`/productos/${ruta}`}
              className="uppercase text-black p-2 w-full cursor-pointer font-medium  transition-all text-sm"
            >
              {texto}
            </Link>
          </button>
